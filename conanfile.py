...
class BotanConan(ConanFile):
    name = 'botan'
    version = '2.7.0'
    url = "https://github.com/AtaLuZiK/conan-botan"
    license = "BSD 2-clause"
    exports = ["LICENSE.md"]
    exports_sources = ["Botan-config.cmake"]
    ...
    def create_configure_cmd(self):
        ...
        if self.settings.os == 'Windows':
            build_flags.append('--msvc-runtime=' + str(self.settings.compiler.runtime))
